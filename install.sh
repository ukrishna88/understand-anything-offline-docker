...
echo "======================================================"
echo ""
echo "  The Docker container is running in STANDBY MODE."
echo "  This is normal — it's ready for your AI tool to use."
echo ""
echo "  ── What to do next ──────────────────────────────────"
echo ""
echo "  Step 1: Generate a knowledge graph"
echo "    Open your AI coding tool (Claude, Cursor, etc.)"
echo "    in your project directory and run:"
echo ""
echo "      /understand"
echo ""
echo "    This analyzes your codebase and creates"
echo "    .understand-anything/knowledge-graph.json"
echo ""
echo "  Step 2: View the dashboard"
echo "    Once the graph is generated:"
echo ""
echo "      understand-dashboard /path/to/your/project"
echo ""
echo "    This restarts the container to serve the dashboard"
echo "    at http://localhost:5173"
echo ""
echo "  ── About standby mode ───────────────────────────────"
echo ""
echo "  The container is running but NOT serving a dashboard"
echo "  yet — that's expected. It's alive so your AI tool can"
echo "  execute node/python3/pnpm commands inside it via:"
echo ""
echo "      ua-exec node --version"
echo "      ua-exec python3 --version"
echo ""
